...
namespace OpenGL
{
    class Tjall : IEffect
    {
        ...
        /// <summary>
        /// Constructor for Tjall effect
        /// </summary>
        /// <param name="chess">Chessboard</param>
     
        /// <param name="txt">Text printer</param>
        public Tjall (ref Chess chess, ref Text2D txt)
        {
            disposed = false;
         //   slideshowImage1 = Util.LoadTexture(Util.CurrentExecutionPath + "/gfx/.jpg");
         //   slideshowImage2 = Util.LoadTexture(Util.CurrentExecutionPath + "/gfx/.jpg");
          //  slideshowImage3 = Util.LoadTexture(Util.CurrentExecutionPath + "/gfx/.jpg");
       ...
       /// </summary>
        ...
        public void Draw(string Date)
        {
            ...
            bakground.Draw(Date, Chess.ChessColor.BlackLightGreen);
            text.Draw("Tjällossningen", Text2D.FontName.CandyPurple, new OpenTK.Vector3(0.9f, 0.2f, 1.0f), new OpenTK.Vector2(0.10f, 0.10f), new OpenTK.Vector2(0.0f, 0.0f), 1.5f);
            updateImages();
            DrawImage();
        }
    }
